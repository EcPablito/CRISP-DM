...
def show_cover():
    ...
    st.markdown(
        """
        <div class="subtitle">
        DISEÑO DE UNA ARQUITECTURA EMPRESARIAL BASADA EN TOGAF INTEGRADA CON CRISP-DM PARA FORTALECER LA TOMA DE DECISIONES BASADA EN DATOS EN UNA EMPRESA DEL SECTOR TEXTIL.
        </div>
        """,
        unsafe_allow_html=True
    )
